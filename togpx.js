import {DOMImplementation, XMLSerializer as Serializer} from '@xmldom/xmldom';
...
!(function (e) {
  typeof exports === 'object'
    ...
    ? (global.togpx = e())
    : typeof self !== 'undefined' && (self.togpx = e());
})(function () {
  ...
  })(
    {
      ...
      2: [
        function (require, module, exports) {
          ...
          let XMLSerializer = window && window.XMLSerializer;
          ...
          var JXON = new (function () {
            ...
            this.unbuild = function (oObjTree) {
              var oNewDoc = document.implementation.createDocument(
                '',
                '',
                null,
              );
